...
export default function Profile() {
    ...
    const setUserFollowing = () => {
        fetch(`/user/${id}/following`)
            ...
            .then((data) => {
                setUserFollowList(data.follow_list)
            });
                        ...
                        {user ? <div className="col-sm">
                            ...
                            <div className="card mb-3 sticky-top" style={{ width: "18rem" }}>
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Following: {userFollowList ? userFollowList[0].follows.length : 0}</p>
                                    <p className="card-text">Followed by: {userFollowList ? userFollowList[0].followed_by.length : 0}</p>
